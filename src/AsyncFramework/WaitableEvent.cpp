...
namespace
{
    ...
    private:
        ...
        // allocated, currently unused handles
...
bool CWaitableEvent::TestTimeout() const
{
...
bool CWaitableEvent::WaitForTimeout(DWORD milliSeconds)
{
    return WaitForSingleObject (event, milliSeconds) == WAIT_TIMEOUT;
}
