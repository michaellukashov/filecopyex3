 ...
 * efficiently wait for at least one job to be finished unless
...
private:
     ...
     *
     * The number of threads handed out to job schedulers
    ...
    /// This is non-trivial as it may race with CThreadPool::Release
